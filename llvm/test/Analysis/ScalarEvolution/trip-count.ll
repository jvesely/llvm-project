...
; CHECK-NEXT:  Loop %bb3: min backedge-taken count is 10000
...
; CHECK-NEXT:  Loop %preheader: min backedge-taken count is 7
...
; CHECK-NEXT:  Loop %loop: min backedge-taken count is -1431655751
