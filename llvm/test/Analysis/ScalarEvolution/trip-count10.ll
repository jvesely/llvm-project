...
; CHECK-NEXT:  Loop %loop: min backedge-taken count is false
...
; CHECK-NEXT:  Loop %loophead: Unpredictable min backedge-taken count.
...
; CHECK-NEXT:  Loop %loop: min backedge-taken count is 1
...
; CHECK-NEXT:  Loop %for.body.i: Unpredictable min backedge-taken count.
