...
public:
  ...
  /// Custom constructors and destructors since we use unions.
  ConstantRange(ConstantRange &&Other);
  ConstantRange(const ConstantRange &Other);
  ConstantRange & operator = (ConstantRange &&Other);
  ...
  /// Return the largest signed value contained in the ConstantRange.
  APFloat getSignedMaxFP() const;

  /// Return the smallest signed value contained in the ConstantRange.
  APInt getSignedMin() const;

  /// Return the smallest signed value contained in the ConstantRange.
  APFloat getSignedMinFP() const;
